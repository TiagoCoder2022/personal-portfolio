...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="container mx-auto flex flex-col items-center z-20"
    >
      <TitleSection>Contact</TitleSection>

      <div className="lg:grid lg:grid-cols-2 gap-60">
        <div>
          <motion.div
        ...
        <motion.form
          ...
          className="border flex flex-col rounded-md gap-y-6 pb-16 p-6 w-full items-start max-w-3xl backdrop-blur-md"
        >
          <input
